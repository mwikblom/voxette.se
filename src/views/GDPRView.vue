...
<template>
  <div>
    ...
    <p>
      ...
      samlas in. Var och en i kören ansvarar för att uppgifterna är korrekta och relevanta. Uppgifterna kommer tas bort
      så snart en medlem ej längre är aktiv såvida personen själv inte önskar ta del av utskick.
    </p>
  </div>
</template>
